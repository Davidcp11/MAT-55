    ...
    while not numeroInteiro(opcao) or not (int(opcao) <= 3 and int(opcao) >= 1):
        ...
        if opcao == '1':
            if not triangularInferior(A):
                print(
                    "A matriz inserida não é triangular inferior e portanto não condiz com o método da Substituição Direta")
                print("\n")
                opcao = 0
            else:
                print("Solução: ")
            ...
            if not triangularSuperior(A):
                print(
                    "A matriz inserida não é triangular superior e portanto não condiz com o método da Substituição Inversa")
                print("\n")
                opcao = 0
            else:
                print("Solução: ")
